...
//      yield* _mapNeedPinHashState();
  ...
  Stream<MainState> _mapNewPinSubmitToState(String pin) async* {
    pinHash(pin).then((theHash) {
      ...
      storage.write(
          key: 'pinHash',
          value: theHash); // store pinHash in secure & persistent storage
      // put in LIF
...
//      var mFrom = "777250221000";
  ...
  Stream<MainState> _mapQrAttend1ScanToState(
    ...
    yield MainState.contScan(exitRoute, crypto, front, flash, position,
        screenName, size, fSize, exitSize, exitString);
  }
