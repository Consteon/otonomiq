...
class _MapPageState extends State<MapPage> with WidgetsBindingObserver {
  ...
  double? get _distanceToCentre => (_site == null || !_hasFix)
      ? null
      : distanceToSite(
          _site!, _currentPoint.latitude, _currentPoint.longitude);
  ...
  @override
  Widget build(BuildContext context) => _isV6 ? _buildV6(context) : _buildClassic();
  ...
  Widget _map(Color primary) {
    ...
    final LatLng? centre =
        _site == null ? null : LatLng(_site!.lat, _site!.lng);
    ...
    return ExcludeSemantics(
      child: Row(
        ...
        children: <Widget>[
          _legendChip(
            const BoxDecoration(
                color: OtqPalette.v6Secondary, shape: BoxShape.circle),
            'Anda',
          ),
      ...
      child: SingleChildScrollView(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Expanded(
                child: _stat('Ke batas', metersLabel(boundary),
              ...
              const SizedBox(width: 8),
              Expanded(
                child: _stat('Radius', metersLabel(_site?.radius)),
              ),
            ],
          ),
  ...
  String get _statusSentence {
    ...
    switch (_status) {
      ...
      case MapFixStatus.outside:
        final String away =
            metersLabel(metersToBoundary(_distanceToCentre, _site!.radius));
        final String name = _site!.name.trim();
        return name.isEmpty
  ...
  Widget _stat(String key, String value,
      ...
      child: Row(
        ...
        children: const <Widget>[
          Icon(Icons.error_outline,
              size: 18, color: OtqPalette.warningText),
          SizedBox(width: 8),
          Expanded(
            child: Text(
          ...
          children: <Widget>[
            Container(
              ...
              child: const Icon(Icons.location_off_outlined,
                  size: 34, color: OtqPalette.v6MutedFg),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () => unawaited(serviceOff
                    ? Geolocator.openLocationSettings()
                    : Geolocator.openAppSettings()),
                child: Text(serviceOff
