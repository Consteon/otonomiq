class Validators {
  ...
  static final RegExp _phoneRegExp = RegExp(
    // TODO put international phone (not only Id) regex that match firebase phone authentication
  ...
  static final RegExp _vidRegExp = RegExp(
    r'(\d{12})',
  );
  ...
  static isValidSmsCode(String smsCode) {
  ...
  static isValidVid(String vid) {
    return _vidRegExp.hasMatch(vid);
  }
  static isValidPin(String vid) {
