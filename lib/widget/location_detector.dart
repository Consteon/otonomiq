...
class _LocationDetectorState extends State<LocationDetector>
  ...
  Widget _buildClassic(BuildContext context) {
    ...
    final Color accuracyFg =
        _isLowAccuracy ? OtqPalette.warningText : mutedFg;
          ...
          if (_accuracy != null)
            Row(
              children: [
                ...
                Text(_accuracyText, style: TextStyle(fontSize: 12, color: accuracyFg)),
                const SizedBox(width: 8),
  ...
  Widget _buildV4(BuildContext context) {
    ...
    final Color fgMuted =
        onDark ? Colors.white.withValues(alpha: 0.86) : OtqPalette.mutedFg;
  ...
  Widget _refreshLink(Color fgMuted) {
    return Semantics(
      ...
      child: TextButton.icon(
        ...
        label: Text('Diperbarui $_formattedUpdatedAt',
