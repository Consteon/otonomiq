...
class _FtzScannerScreenState extends State<FtzScannerScreen>
        ...
        child: DecoratedBox(
          ...
          child: const Padding(
            ...
            child: CircularProgressIndicator(
              strokeWidth: 3,
              valueColor:
                  AlwaysStoppedAnimation<Color>(OtqPalette.successOnDark),
            ),
          ),
        ),
      ),
  ...
  Widget _hint(Rect frame, {required bool front, required bool torchOn}) {
    ...
    if (_isProcessing) {
      ...
      body = 'Untuk kode QR di layar perangkat lain; '
  ...
  Widget _sheet(double bottomInset,
      {required bool front, required bool torchOn}) {
...
class _ViewfinderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Path hole = Path()
      ..addRRect(
          RRect.fromRectAndRadius(frame, const Radius.circular(radius)));
    canvas.drawPath(
