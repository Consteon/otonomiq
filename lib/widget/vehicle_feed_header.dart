...
class _VehicleFeedHeaderState extends State<VehicleFeedHeader> {
  ...
  Map<String, dynamic>? _findCheckerDoc() {
    ...
    final String checkerVid =
        (transactionStore.state.screenTx['#VID'] ?? '').toString().trim();
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final String station =
          (widget.component['station'] ?? '').toString().trim();
      ...
      final String menuRoute =
          (widget.component['menuRoute'] ?? '').toString().trim();
  ...
  Widget _buildCountBox({
    ...
    final Color bgColor =
        highlight ? const Color(0xFFFEF3C7) : const Color(0xFFF9FAFB);
    final Color countColor =
        highlight ? const Color(0xFFD97706) : const Color(0xFF1F2937);
    final Color labelColor =
        highlight ? const Color(0xFFB45309) : const Color(0xFF6B7280);
