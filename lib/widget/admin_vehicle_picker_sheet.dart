...
class _VehiclePickerSheetState extends State<VehiclePickerSheet> {
  ...
  Future<void> _onConfirm() async {
    ...
    final bool success = await executeUpdateEventRow(
      ...
      tokens: {
        '{taskVid}': widget.taskVid,
        '{vehicleId}': _selectedLv!,
      },
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bool selfBusy = VehiclePickerSheet.isVehicleSelfBusy(
                      veh, widget.busySelfField);
                  final bool isBusy = selfBusy ||
                      VehiclePickerSheet.isVehicleBusy(
                          widget.busyDocs, widget.busySearch, lv);
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed:
                      (_selectedLv != null && !_writing) ? _onConfirm : null,
