...
class _MapPointPickerState extends State<MapPointPicker> {
  ...
  void initState() {
    ...
    _addressPosition =
        parseOptionalPosition(widget.component['addressPosition']);
    ...
    _initialCenter =
        parseLatLng(widget.component['initialCenter']?.toString());
  ...
  void _writeToController() {
    ...
    addToTxfController(_position, widget.scrName, value,
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: Text(
                          mapPickerSlot(_texts, 1, 'Lokasi Saya')),
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                          mapPickerSlot(_texts, 2, 'Cari di Peta')),
              ...
              Row(
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      icon: const Icon(Icons.edit_location_outlined,
                          size: 16),
                      label: Text(
                          mapPickerSlot(_texts, 3, 'Ganti Lokasi')),
                      style: OutlinedButton.styleFrom(
                        foregroundColor: const Color(0xFF374151),
                  ...
                  OutlinedButton.icon(
                    ...
                    label:
                        Text(mapPickerSlot(_texts, 9, 'Hapus')),
                    style: OutlinedButton.styleFrom(
...
class _MapPointPickerScreen extends StatefulWidget {
  ...
  @override
  State<_MapPointPickerScreen> createState() =>
...
class _MapPointPickerScreenState extends State<_MapPointPickerScreen> {
  ...
  double get _resultsTop => widget.pasteEnabled
      ? _pasteRowTop + _pasteRowHeight + _barGap // 120
  ...
  Future<void> _jumpToGps() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content:
                Text(mapPickerSlot(widget.texts, 7, 'GPS error'))),
      );
    }
  }
                      ...
                      child: GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Icon(
                            Icons.location_pin,
                            color: Colors.red
                                .withValues(alpha: _isDraggingPin ? 0.75 : 1),
                            size: 48,
                          ),
                        ),
                      ),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            labelText: mapPickerSlot(
                                widget.texts, 10, 'Tempel Link Lokasi'),
                            ...
                            suffixIcon: _isExpandingLink
                                ...
                                : IconButton(
                                    icon: const Icon(Icons.arrow_forward,
                                        size: 18, color: Color(0xFF3B82F6)),
                                    onPressed: () =>
                                        _onPasteSubmitted(_pasteController.text),
                                  ),
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                              borderSide: BorderSide.none,
