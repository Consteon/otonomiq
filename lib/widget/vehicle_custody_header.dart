  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final String eventField =
          (widget.component['eventField'] ?? 'cnm').toString();
      final String loaderField =
          (widget.component['loaderField'] ?? 'gn').toString();
      final String loadtimeField =
          (widget.component['loadtimeField'] ?? 'ldt').toString();
      ...
      final String loadtime =
          (checkDoc?[loadtimeField] ?? '').toString().trim();
      ...
      final String loadtimeDisplay =
          loadtime.isNotEmpty ? loadtime : '\u{2014}';
