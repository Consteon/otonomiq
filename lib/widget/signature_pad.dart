...
class _SignaturePadState extends State<SignaturePad> {
  ...
  static const Color _emerald = Color(0xFF10B981); // emerald-500 (filled accent)
  ...
  void _onPanUpdate(DragUpdateDetails details) {
    _currentStroke
        .add(clampToCanvas(details.localPosition, _canvasWidth, _canvasHeight));
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String placeholder = _t(
        0, '\u{270D}\u{FE0F} Tap & tarik untuk tanda tangan customer');
    final String clearLabel = _t(1, 'Hapus');
    final String hintEmpty = _t(
        2, 'Opsional \u{00B7} jika customer berkenan tanda tangan');
