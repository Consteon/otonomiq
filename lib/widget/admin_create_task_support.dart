...
class AdminCreateTaskSupport {
  ...
  static void setCustomer(String wizardKey,
      {required String kl,
      required String kn,
      required String al,
      String pic = ''}) {
  ...
  static void setVehicle(String wizardKey,
      {required String vv, required String vn}) {
    draftVehicle[wizardKey] = <String, String>{
      'vv': vv,
      'vn': vn,
    };
  }
  ...
  static String generateTnm(String kl, {int? nowMs}) {
    ...
    final DateTime wibNow =
        DateTime.fromMillisecondsSinceEpoch(now + wibOffsetMs, isUtc: true);
