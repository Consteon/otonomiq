      ...
      switch (tx) {
        ...
        case 'refill':
          if (refillField.isNotEmpty) {
            final int pr = resolveItemQty(entry, refillField, actualRefillField);
...
class _TaskManifestListState extends State<TaskManifestList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final String rawTx =
          (widget.component['txField'] ?? '').toString().trim();
