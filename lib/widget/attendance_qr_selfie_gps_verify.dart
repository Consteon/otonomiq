  ...
  Widget build(BuildContext context) {
    ...
    */
    ...
    Future<void> acquireQrSelfie(String scrName, String originalScrName,
        dynamic component, OtqState locSensor, bool forceSelfie) async {
      int tried = 1;
      String? qrText = empty;
      bool done = false;
      bool qrPhoto = false;
                                ...
                                await showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        // dialog 3
                                        title: Text(
                                            textArray[forceSelfie ? 19 : 9]),
                                        content: Text(
                                            textArray[forceSelfie ? 20 : 9]),
                                        actions: <Widget>[
                                          TextButton(
                                            child: Text(textArray[forceSelfie
                                                ? 21
                                                : 8]), // selfie
                                            onPressed: () {
                                              Navigator.of(context).pop();
