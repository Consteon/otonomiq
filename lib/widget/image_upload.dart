...
class ImageUploadState extends State<ImageUpload> {
  ...
  void saveData(String scrName, String locString) {
    ...
    timerBloc
        .add(const Start(duration: 5)); //  get timerBloc from transactionStore
  ...
  Future<void> _saveFile(
      String ext, var component, String scrName, Key txfKey) async {
    if (await dataOk(context)) {
      ...
      String downloadUrl = await uploadToCloudStorage(_imageFile!.path,
